...
<body style="padding-top: 56px;">
  ...
  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color:#0d1b2a;">
  ...
  <!-- Coordonnées -->
  <div class="text-center mt-4" style="font-size: 1.2rem; color: #0d1b2a;">
    <span class="me-4">
      ...
      <a href="mailto:guillaume.simonet@epitech.eu" class="text-decoration-none"
        style="color: #0d1b2a;">guillaume.simonet@epitech.eu</a>
    </span>
    <span class="me-4">
    ...
    <div class="container">
      ...
      <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="progress" style="height: 25px;">
            <div class="progress-bar" role="progressbar" style="width: 60%; background-color:#3a7ca5;"
              aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">60%</div>
          </div>
        </div>
        ...
        <div class="col-md-6 mt-4">
          ...
          <div class="progress" style="height: 25px;">
            <div class="progress-bar" role="progressbar" style="width: 85%; background-color:#41729f;"
  ...
  <section id="contact" class="py-5 bg-light">
    <div class="container">
      ...
      <div class="text-center">
        <button class="btn" style="background-color:#0d1b2a; color:white; width:300px;">Envoyer</button>
      </div>
    </div>
  </section>

  <!-- Footer -->
  <footer class="text-white text-center py-3" style="background-color:#0d1b2a;">
